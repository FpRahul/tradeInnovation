...
class MenuActionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('menu_actions')->insert(array(
            ...
            array('id' => '5','menuId' => '4','actionName' => 'Update Status','route' => 'users.status','created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '8','menuId' => '5','actionName' => 'Update Status','route' => 'users.status','created_at' => NULL,'updated_at' => NULL),
