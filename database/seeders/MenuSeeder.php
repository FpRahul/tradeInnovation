...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('menus')->insert(array(
            ...
            array('id' => '10','parentId' => '2','menuName' => 'Settings','icon' => NULL,'url' => 'javascript:void(0);','actionRoutes' => 'professions.index,professions.add,professions.status,professions.delete,incorporation.index,incorporations.add,incorporations.status,incorporations.delete,referral.index,referral.add,referral.status,referral.delete','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '11','parentId' => '10','menuName' => 'Professions','icon' => NULL,'url' => 'professions.index','actionRoutes' => 'professions.index,professions.add,professions.status,professions.delete','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '12','parentId' => '10','menuName' => 'Incorporation type','icon' => NULL,'url' => 'incorporation.index','actionRoutes' => 'incorporation.index,incorporations.add,incorporations.status,incorporations.delete','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '13','parentId' => '10','menuName' => 'Referral partner','icon' => NULL,'url' => 'referral.index','actionRoutes' => 'referral.index,referral.add,referral.status,referral.delete','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
