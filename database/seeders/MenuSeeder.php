...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('menus')->insert(array(
            ...
            array('id' => '3','parentId' => '2','menuName' => 'Employee','icon' => NULL,'url' => 'users.listing','actionRoutes' => 'users.listing,users.adduser','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '6','parentId' => '0','menuName' => 'Leads','icon' => 'leads-icon','url' => 'javascript:void(0);','actionRoutes' => 'leads.index,leads.add,leads.assign,leads.archive,leads.quote,leads.logs,leads.delete,lead.invoice,lead.paymentStatus,bussinessScope.index,bussinessScope.add,bussinessScope.status,filingMode.index,filingMode.add,filingMode.status','sequence' => '3','created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '10','parentId' => '2','menuName' => 'Settings','icon' => NULL,'url' => 'javascript:void(0);','actionRoutes' => 'professions.index,professions.add,professions.status,incorporation.index,incorporations.add,incorporations.status,referral.index,referral.add,referral.status,partner.index,partner.add,partner.status  ','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '15','parentId' => '6','menuName' => 'Listing','icon' => NULL,'url' => 'leads.index','actionRoutes' => 'leads.index,leads.add,leads.assign,leads.archive,leads.quote,leads.logs,leads.delete,lead.invoice','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '19','parentId' => '6','menuName' => 'Scope Of Business','icon' => NULL,'url' => 'bussinessScope.index','actionRoutes' => 'bussinessScope.index,bussinessScope.add,bussinessScope.status','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '20','parentId' => '6','menuName' => 'Firm','icon' => NULL,'url' => 'firm.index','actionRoutes' => 'firm.index,firm.add,firm.status','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '21','parentId' => '6','menuName' => 'Payment','icon' => NULL,'url' => 'lead.paymentStatus','actionRoutes' => 'lead.paymentStatus','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            array('id' => '22','parentId' => '6','menuName' => 'Filing Mode','icon' => NULL,'url' => 'filingMode.index','actionRoutes' => 'filingMode.index,filingMode.add,filingMode.status','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
        ));
    }
}
