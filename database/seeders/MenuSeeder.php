...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('menus')->insert(array(
            ...
            array('id' => '6','parentId' => '0','menuName' => 'Leads','icon' => 'leads-icon','url' => 'javascript:void(0);','actionRoutes' => 'leads.index,leads.add,leads.assign,leads.archive,leads.quote,leads.logs,leads.delete,lead.invoice,lead.paymentStatus','sequence' => '3','created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '10','parentId' => '2','menuName' => 'Settings','icon' => NULL,'url' => 'javascript:void(0);','actionRoutes' => 'professions.index,professions.add,professions.status,incorporation.index,incorporations.add,incorporations.status,referral.index,referral.add,referral.status,partner.index,partner.add,partner.status,bussinessScope.index,bussinessScope.add,bussinessScope.status  ','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
            ...
            array('id' => '19','parentId' => '10','menuName' => 'Bussiness Scope','icon' => NULL,'url' => 'bussinessScope.index','actionRoutes' => 'bussinessScope.index,bussinessScope.add,bussinessScope.status','sequence' => NULL,'created_at' => NULL,'updated_at' => NULL),
