                    ...
                    <td style="padding: 40px 20px; text-align: left;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="10" style="border-collapse: collapse; border: 1px solid #ddd; background-color: #fafafa;">
                            <tr>
                                ...
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $client->name }}</td>
                            </tr>
                            <tr>
                                <td width="50%" style="font-size: 14px; font-weight: bold; color: #333; background-color: #f0f0f0; border-bottom: 1px solid #ddd;">Company Name:</td>
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $client->companyName }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $client->mobile }}</td>
                            </tr>
                            <tr>
                                <td width="50%" style="font-size: 14px; font-weight: bold; color: #333; background-color: #f0f0f0; border-bottom: 1px solid #ddd;">Email:</td>
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $client->email }}</td>
                            </tr>
                            <tr>
                                <td width="50%" style="font-size: 14px; font-weight: bold; color: #333; background-color: #f0f0f0; border-bottom: 1px solid #ddd;">Referral Partner:</td>
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $client->referralPartner }}</td>
                            </tr>
                            <tr>
                                <td width="50%" style="font-size: 14px; font-weight: bold; color: #333; background-color: #f0f0f0; border-bottom: 1px solid #ddd;">Address:</td>
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $client->address }}</td>
                            </tr>
                            <tr>
                                <td width="50%" style="font-size: 14px; font-weight: bold; color: #333; background-color: #f0f0f0;">Registered under Startup Scheme:</td>
                                <td width="50%" style="font-size: 14px; color: #555;">{{ $client->registered ? 'Yes' : 'No' }}</td>
                            </tr>
                        </table>
                        <p style="font-size: 16px;text-align: center; line-height: 1.2; margin: 35px 0 0; color: #555;">
                            If you have any questions, feel free to <br> <a href="mailto:support@yourdomain.com" style="color: #1c194d; text-decoration: underline;">contact us</a>. We're here to help!
                        </p>
                        <p style="text-align: center;margin: 15px 0 0;">
                            <a href="mailto:support@yourdomain.com" style="background-color: #1c194d;color: #fff;display: inline-block;padding: 15px 35px;border-radius: 45px; text-decoration: none;text-transform: capitalize;">contact us</a>
                        </p>
                    </td>
                </tr>
                <!-- Footer Section -->
