            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15); overflow: hidden;">
                ...
                <tr>
                    <td style="padding: 40px 20px; text-align: left;">
                        ...
                        Below are your updated account credentials:
                        </p>
                        <!-- Details Table -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="10" style="border-collapse: collapse; border: 1px solid #ddd; background-color: #fafafa;">
                            <tr>
                                ...
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $updatePass->email}}</td>
                            </tr>
                            <tr>
                                <td width="50%" style="font-size: 14px; font-weight: bold; color: #333; background-color: #f0f0f0; border-bottom: 1px solid #ddd;">New Password:</td>
                                <td width="50%" style="font-size: 14px; color: #555; border-bottom: 1px solid #ddd;">{{ $newPass }}</td>
                            </tr>
