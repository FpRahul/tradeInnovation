<div class=" flex justify-between items-center py-[15px] px-[15px] xl:pr-[22px] xl:pl-[30px] ">
    ...
    <h3 class="hidden xl:block text-[20px] font-[600] leading-[24px] text-[#13103A] tracking-[0.02em]">{{$header_title_name}}</h3>
