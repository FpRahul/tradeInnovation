...
<div>
    ...
    <div class="flex items-center justify-between mb-[20px]">
        <div>
            <h3 class="text-[20px] font-[500] leading-[24px] text-[#13103A] tracking-[0.02em] mb-1.5">Manage Firm</h3>
            <ul class="flex items-center text-[14px] font-[400] leading-[16px] text-[#000000] gap-[5px]">
                <li>{{$header_title_name}}</li> /
                <li class="text-gray">Partner</li>
            </ul>
        </div>
    ...
    <div class="shadow-[0px_0px_13px_5px_#0000000f] bg-white rounded-[20px] ">
        <div class="py-[25px] px-[20px] flex items-center justify-end">
            ...
            <div class="relative w-[217px]">
                ...
                <input type="search" name="search" id="search" value="" placeholder="Search By Firm Name" class="search !outline-none border border-[#0000001A] h-[40px] w-full p-[10px] pl-[42px] bg-transparent text-[#000000] placeholder:text-[#6F6F6F] rounded-[10px] text-[14px] font-[400] leading-[16px] ">
            </div>
        </div>
...
<script>
    $(document).on('click','.openModalFirm',function(){
