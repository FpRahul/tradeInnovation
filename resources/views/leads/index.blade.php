                    ...
                    @if ($leadList && $leadList->isNotEmpty())
                       ...
                       <tr>
                        ...
                        <td class="text-center border-b-[1px] border-[#0000001A] py-[12px] px-[15px]">
                            @if((in_array('leads.add',$permissionDetails['accessableRoutes']) || in_array('leads.logs',$permissionDetails['accessableRoutes']) || in_array('leads.archive',$permissionDetails['accessableRoutes'])) || in_array('lead.invoice',$permissionDetails['accessableRoutes']) || auth()->user()->role==1)
