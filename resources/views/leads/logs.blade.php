...
<div>
    ...
    {{-- <div class="overflow-x-scroll">
        <table class="w-full">
            <tr>
                <th class="bg-[#FAFAFA] px-[10px] py-[15px] border-t-[1px] border-t-[#f5f5f5] text-left text-[#000] text-[15px] font-[600] whitespace-nowrap">
                    <div class="flex items-center gap-[5px]">
                        Date: 
                        <div class="flex items-center gap-[10px]">
                            <div class="flex items-center justify-center w-[35px] h-[35px] gap-[5px] bg-[#fff] p-[4px] rounded-[5px] border-[1px] border-[#ccc]">
                            ...
                            <div class="flex items-center justify-center w-[35px] h-[35px] gap-[5px] bg-[#fff] p-[4px] rounded-[5px] border-[1px] border-[#ccc]">
                                <svg width="15" height="15" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_339_6018)">
                                        <path d="M6.00073 5.32669C6.87702 5.32669 7.5874 4.62527 7.5874 3.76003C7.5874 2.89478 6.87702 2.19336 6.00073 2.19336C5.12444 2.19336 4.41406 2.89478 4.41406 3.76003C4.41406 4.62527 5.12444 5.32669 6.00073 5.32669Z" fill="#13103A"></path>
                ...
                <th class="bg-[#FAFAFA] px-[10px] py-[15px] border-t-[1px] border-t-[#f5f5f5] text-left text-[#000] text-[15px] font-[600] whitespace-nowrap">Stage</th>
                <th class="bg-[#FAFAFA] px-[10px] py-[15px] border-t-[1px] border-t-[#f5f5f5] text-center text-[#000] text-[15px] font-[600] whitespace-nowrap">Status</th>
                <th class="bg-[#FAFAFA] px-[10px] py-[15px] border-t-[1px] border-t-[#f5f5f5] text-right text-[#000] text-[15px] font-[600] whitespace-nowrap">Action</th>
            </tr>
            ...
            <tr>
                ...
                <td class="bg-[#fff] px-[10px] py-[15px] border-t-[1px] border-t-[#f5f5f5] text-center  text-[#000] text-[13px] font-[400] whitespace-nowrap">
                    <div class="flex items-center justify-center w-[100px]  bg-[#FDF5D5] px-[5px] py-[6px] rounded-[8px] text-[13px] text-[#E3BF3F] font-[600] m-auto ">Assign</div>
                    <div class="flex items-center justify-center w-[100px]  bg-[#EBF3FE] px-[5px] py-[6px] rounded-[8px] text-[13px] text-[#4F8BEA] font-[600] m-auto ">Completed</div>
                </td>

                <td class="bg-[#fff] px-[10px] py-[15px] border-t-[1px] border-t-[#f5f5f5] text-right  text-[#000] text-[13px] font-[400] whitespace-nowrap">
                    <div class="flex items-center justify-end gap-[10px]">
                         
                        <a href="#" class="flex items-center justify-center w-[35px] h-[35px] gap-[5px] bg-[#fff] p-[4px] rounded-[5px] border-[1px] border-[#ccc]">
