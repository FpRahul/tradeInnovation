            ...
            <div class="py-[15px] md:py-[25px] px-[15px] md:px-[20px] gap-[10px] flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex max-w-[600px] gap-[10px] w-full items-center justify-start">
                    ...
                    <select name="status" id="status" class="allform-select2 !outline-none h-[40px] border border-[#0000001A] w-full md:w-[90px] rounded-[10px] p-[10px] text-[14px] font-[400] leading-[16px] text-[#13103A]">
                        ...
                        @endphp
                        <option value="{{ $details->id }}">{{ $statusText }}</option>
                        @endforeach
                                ...
                                <div class="dropdown inline-block relative ml-[auto] mr-[20px] ">
                                    ...
                                    <div class="dropdown_menus absolute right-0 z-10 mt-2 w-[100px] origin-top-right rounded-md bg-white shadow-md ring-1 ring-black/5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                        <div class="text-start" role="none">
                                            <a href="{{ route('task.detail')}}" class="block border-b-[1px] border-[#0000001A] hover:bg-[#f7f7f7] px-3 py-1 text-[12px] text-gray-700">Follow Up</a>
