            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="min-w-[900px]">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-b-[1px] border-[#0000001A] text-start text-[14px] font-[400] leading-[16px] text-[#6F6F6F] py-[12px] px-[15px]">
                            <span class="text-[#ffffff] bg-[#6c757d] inline-block text-center min-w-[100px] py-[5px] px-[10px] rounded-[5px] ">Expired</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="border-b-[1px] border-[#0000001A] text-start text-[14px] font-[400] leading-[16px] text-[#6F6F6F] py-[12px] px-[15px]">
                            <span class="text-[#ffffff] bg-[#218838] inline-block text-center min-w-[100px] py-[5px] px-[10px] rounded-[5px] ">Completed</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="border-b-[1px] border-[#0000001A] text-start text-[14px] font-[400] leading-[16px] text-[#6F6F6F] py-[12px] px-[15px]">
                            <span class="text-[#13103A] bg-[#fd7e14] inline-block text-center min-w-[100px] py-[5px] px-[10px] rounded-[5px] ">Hold</span>
                        </td>
