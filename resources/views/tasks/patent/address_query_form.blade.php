...
<div class="shadow-[0px_0px_13px_5px_#0000000f] bg-white px-[15px] md:px-[30px] py-[20px] rounded-[20px] mt-[20px] overflow-hidden ">
   <form action="{{route('task.patentAddressQueryFormStatus',['id'=>$id]) }}" method="POST" class="space-y-[20px]" enctype="multipart/form-data">
      @csrf
      ...
      <tr>
         <td style="padding: 15px 15px; text-align: left;">
            ...
            <p style="font-size: 16px; line-height: 1.8; margin: 0 0 20px; color: #555;">
                We are initiating the process for your patent change address. Please find the attached query form and fill it with the required details. Once we receive the completed form, we will proceed further. If you have any questions, feel free to reach out to us.
            </p>
