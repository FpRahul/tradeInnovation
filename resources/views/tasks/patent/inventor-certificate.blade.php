...
<div class="shadow-[0px_0px_13px_5px_#0000000f] bg-white px-[15px] md:px-[30px] py-[20px] rounded-[20px] mt-[20px] overflow-hidden ">
   ...
   <form action="{{route('task.patentInventorCertificateSubmit',['id'=>$id]) }}" method="POST" class="space-y-[20px]" enctype="multipart/form-data">
      @csrf
      ...
      <tr>
         <td style="padding: 15px 15px; text-align: left;">
            ...
            <p style="font-size: 16px; line-height: 1.8; margin: 0 0 20px; color: #555;">
                Your request for the issuance of the <strong>Inventor Certificate</strong> has been successfully processed. Below are the details of your certificate and the associated charges:
            </p>
            ...
            <table class="w-[100%] border-[1px] border-[#f2f2f2]" >
               ...
               <tr>
                  <td>
                     <table class="w-full">
                        <tr>
                           <th class="px-[10px] py-[10px] text-[13px] font-[600] border-b-[1px] border-b-[#f2f2f2]  border-r-[1px] border-r-[#f2f2f2]">Service</th>
                           <th class="px-[10px] py-[10px] text-[13px] font-[600] border-b-[1px] border-b-[#f2f2f2] border-r-[1px] border-r-[#f2f2f2]">Sub Service</th>
                           <th class="px-[10px] py-[10px] text-[13px] font-[600] border-b-[1px] border-b-[#f2f2f2] border-r-[1px] border-r-[#f2f2f2]">Stage</th>
                        </tr>
                        @if(!empty($taskDetails))
                           @foreach ($taskDetails as $serK => $serV)                              
                              <tr>
                                 ...
                                 <td class="px-[10px] py-[10px] text-[12px] font-[400] text-[#000] border-b-[1px] border-b-[#f2f2f2] border-r-[1px] border-r-[#f2f2f2]">{{$serV->serviceSatge->title}}</td>
                              </tr>    
                           @endforeach
                        @endif                    
                     </table>
