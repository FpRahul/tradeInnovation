...
<div class="shadow-[0px_0px_13px_5px_#0000000f] bg-white px-[15px] md:px-[30px] py-[20px] rounded-[20px] mt-[20px] overflow-hidden ">
   ...
   <form action="{{route('task.patentRevocationSubmit',['id'=>$id]) }}" method="POST" class="space-y-[20px]" enctype="multipart/form-data">
      @csrf
      <strong class="mt-4 block"> Update Current Task</strong>
      <div class="flex flex-col md:flex-row gap-[20px]">
         <div class="w-full md:w-1/2">
            <label for="patent_number" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Patent Number</label>           
            <input type="text" name="patent_number" id="patent_number" value="" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none">
         </div>
         <div class="w-full md:w-1/2">
            <label for="patent_title" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Patent Title</label>           
            <input type="text" name="patent_title" id="patent_title" value="" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none">
         </div>
      </div>
      <div class="flex flex-col md:flex-row gap-[20px]">
         <div class="w-full md:w-1/2">
            <label for="applicant_name" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Applicant Name</label>           
            <input type="text" name="applicant_name" id="applicant_name" value="" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none">
         </div>
         ...
         @enderror
      <div class="">
         <label for="description" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Reason of revocation</label>
