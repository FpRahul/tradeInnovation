   ...
   <form action="{{route('task.applicantEvidenceSubmissionStatus',['id'=>$id]) }}" method="POST" class="space-y-[20px]" enctype="multipart/form-data">
      ...
      <div class="flex flex-col md:flex-row gap-[20px]">
         ...
         <div class="w-full md:w-1/2">
            ...
            <input type="text" name="applicant_status" id="applicant_status" value=""  placeholder="Enter affidavit rule status"class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" >
