...
<div class="shadow-[0px_0px_13px_5px_#0000000f] bg-white px-[15px] md:px-[30px] py-[20px] rounded-[20px] mt-[20px] overflow-hidden ">
   <form action="{{route('task.expidetProcessFileStatus',['id'=>$id]) }}" method="POST" class="space-y-[20px]" enctype="multipart/form-data">
      @csrf
      ...
      <tr>
         <td style="padding: 15px 15px; text-align: left;">
            ...
            <p style="font-size: 16px; line-height: 1.8; margin: 0 0 20px; color: #555;">
                ...
                Thank you for confirming your details and documents. Your trademark expidet process  application has been filed, and the filing process is now complete.
            </p>
