        ...
        <form method="POST" action="{{ route('users.addassociate',['id'=>$newAssociate->id])}}" class="py-[15px] md:py-[25px] px-[15px] md:px-[30px] space-y-[20px]">
            ...
            <div class="flex flex-col md:flex-row gap-[20px]">
                <div class="w-full md:w-1/2">
                    ...
                    <input type="text" name="name" id="name" value="{{ucwords(old('name') ? old('name') : $newAssociate->name)}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" placeholder="Enter Name" required>
                    @error('name')
                ...
                <div class="w-full lg:w-1/2">
                    <div class="shadow-lg p-[25px] rounded-[8px] border-[1px] border-[#ccc] currentAddressDiv">                        
                        ...
                        <div class="mb-[10px]">
                            ...
                            <input type="text" name="curr_city" id="curr_city" value="{{ ucwords(old('curr_city') ? old('curr_city') : (!empty($newAssociateDetails) ? $newAssociateDetails->curr_city : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="curr_state" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">State</label>
                            <input type="text" name="curr_state" id="curr_state" value="{{ ucwords(old('curr_state') ? old('curr_state') : (!empty($newAssociateDetails) ? $newAssociateDetails->curr_state : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="curr_zip" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Zip Code</label>
                            <input type="text" name="curr_zip" id="curr_zip" value="{{ ucwords(old('curr_zip') ? old('curr_zip') : (!empty($newAssociateDetails) ? $newAssociateDetails->curr_zip : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>                        
                    </div>
                </div>
                <div class="w-full lg:w-1/2">
                    <div class="shadow-lg p-[25px] rounded-[8px] border-[1px] border-[#ccc]">
                        ...
                        <div class="mb-[10px]">
                            ...
                            <textarea R type="text" name="permanentAddress" id="permanentAddress" class="w-full h-[120px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" placeholder="Permanent Address" required>{{ ucwords(old('permanentAddress') ? old('permanentAddress') : (!empty($newAssociateDetails->permanentAddress) ? $newAssociateDetails->permanentAddress :'')) }}</textarea>
                        ...
                        <div class="mb-[10px]">
                            ...
                            <input type="text" name="perma_city" id="perma_city" value="{{ ucwords(old('perma_city') ? old('perma_city') : (!empty($newAssociateDetails) ? $newAssociateDetails->perma_city : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="perma_state" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">State</label>
                            <input type="text" name="perma_state" id="perma_state" value="{{ ucwords(old('perma_state') ? old('perma_state') : (!empty($newAssociateDetails) ? $newAssociateDetails->perma_state : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="perma_zip" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Zip Code</label>
                            <input type="text" name="perma_zip" id="perma_zip" value="{{ ucwords(old('perma_zip') ? old('perma_zip') : (!empty($newAssociateDetails) ? $newAssociateDetails->perma_zip : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div> 
