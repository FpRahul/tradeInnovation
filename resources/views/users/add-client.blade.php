    ...
    <div class="shadow-[0px_0px_13px_5px_#0000000f] bg-white rounded-[20px]">
        <form method="POST" action="{{ route('users.addclient',['id' => $newClient->id])}}" class="py-[15px] md:py-[25px] px-[15px] md:px-[30px] space-y-[20px]">
            ...
            <div class="flex flex-col md:flex-row gap-[20px] !mt-0">
                ...
                <div class="w-full md:w-1/2">
                    <label for="name" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Last Name</label>
                    <input type="text" name="last_name" id="last_name" value="{{ ucwords(old('last_name') ? old('last_name') : $newClient->last_name)}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" placeholder="Enter Name">
                    @error('last_name')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="flex flex-col md:flex-row gap-[20px]">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <input type="number" name="number" id="number" data-id="{{$newClient->id > 0 ? $newClient->id : 0}}" maxlength="10" value="{{ old('number') ? old('number') : $newClient->mobile}}" class="checkDuplicateMobile w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" placeholder="Enter Number" required>
