        ...
        <form>
            ...
            <div class="overflow-x-auto border-b-[1px] border-[#0000001A]">
                <table width="100%" cellpadding="0" cellspacing="0" class="min-w-[700px]">
                    <thead>
                        <tr>
                            <th class="text-start bg-[#D9D9D933] text-[14px] font-[400] leading-[16px] text-[#000000] py-[14px] px-[15px] pl-[30px]">
                                <input type="checkbox" name="selectall" id="selectall" class="w-[12px] h-[12px]">
                            </th>
