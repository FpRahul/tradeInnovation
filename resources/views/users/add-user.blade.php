        ...
        <form method="POST" action="{{ route('users.adduser', ['id' => $newUser->id]) }}" enctype="multipart/form-data" class="py-[15px] md:py-[25px] px-[15px] md:px-[30px] space-y-[20px]">
            ...
            <div class="flex flex-col md:flex-row gap-[20px]">
                <div class="w-full md:w-1/2">
                    ...
                    <input type="text" name="name" id="name" value="{{ ucwords(old('name') ? old('name') : $newUser->name) }}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" placeholder="Name" required>
                    @error('name')
                                    ...
                                    <div data-repeater-item class="flex flex-wrap items-end  gap-[20px]">
                                        <div class="w-full flex items-end justify-between flex-wrap lg:flex-nowrap gap-[20px]">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <input type="text" name="employerName" id="employerName" value="{{ucwords($exVal['employerName']) }}"
            ...
            <div class="flex flex-col md:flex-row gap-[20px]">
                <div class="w-full md:w-1/2">
                    ...
                    <input type="text" name="skill" id="skill" value="{{ucwords( old('skill') ? old('skill') : (!empty($newUserDetails->skills) ? $newUserDetails->skills :'')) }}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255"  required>
                    @error('skill')
                    <div class="text-red-500 text-sm mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="w-full lg:w-1/2">
                    <div class="shadow-lg p-[25px] rounded-[8px] border-[1px] border-[#ccc] currentAddressDiv">                        
                        ...
                        <div class="mb-[10px]">
                            ...
                            <input type="text" name="curr_city" id="curr_city" value="{{ucwords(old('curr_city') ? old('curr_city') :  (!empty($newUserDetails) ? $newUserDetails->curr_city : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="curr_state" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">State</label>
                            <input type="text" name="curr_state" id="curr_state" value="{{ucwords(old('curr_state') ? old('curr_state') : (!empty($newUserDetails) ? $newUserDetails->curr_state : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="curr_zip" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Zip Code</label>
                            <input type="text" name="curr_zip" id="curr_zip" value="{{ucwords(old('curr_zip') ? old('curr_zip') : (!empty($newUserDetails) ? $newUserDetails->curr_zip : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>                        
                    </div>
                </div>
                <div class="w-full lg:w-1/2">
                    <div class="shadow-lg p-[25px] rounded-[8px] border-[1px] border-[#ccc]">
                        ...
                        <div class="mb-[10px]">
                            ...
                            <input type="text" name="perma_city" id="perma_city" value="{{ucwords(old('perma_city') ? old('perma_city') : (!empty($newUserDetails) ? $newUserDetails->perma_city : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="perma_state" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">State</label>
                            <input type="text" name="perma_state" id="perma_state" value="{{ucwords(old('perma_state') ? old('perma_state') : (!empty($newUserDetails) ? $newUserDetails->perma_state : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div>
                        <div class="mb-[10px]">
                            <label for="perma_zip" class="block text-[14px] font-[400] leading-[16px] text-[#000000] mb-[5px]">Zip Code</label>
                            <input type="text" name="perma_zip" id="perma_zip" value="{{ucwords(old('perma_zip') ? old('perma_zip') : (!empty($newUserDetails) ? $newUserDetails->perma_zip : ''))}}" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" maxlength="255" >
                        </div> 
