            ...
            <div>
                <div>
                    ...
                    <div class="relative flex flex-wrap gap-[10px]">
                        <!-- <img src="" width="70" height="70" class="w-[150px] h-[150px] rounded-[10px] object-cover shadow-[0_0_5px_rgba(0,0,0,0.3)]" /> -->
                        <div class="relative">
                            ...
                            <input type="file" name="profilePic" id="profilePic" class="w-0 opacity-0 absolute top-0 left-0">
                        </div>
                    </div>
                </div>
            </div>
