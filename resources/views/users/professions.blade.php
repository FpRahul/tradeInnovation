...
<div>
    ...
    <div class="flex items-center justify-between mb-[20px]">
        ...
        <a href="javascript:void(0)" type="button" data-btn-name="Add"  data-name="" data-id="0" data-modal-target="assignUserModal" data-modal-toggle="assignUserModal"  class="openModalProf inline-flex items-center gap-[10px] text-[13px] font-[500] leading-[15px] text-[#ffffff] tracking-[0.01em] bg-[#13103A] rounded-[10px] py-[12px] px-[30px] ">
                        ...
                        @foreach ($categoryData as $newCategorylist)
                            ...
                            <tr>
                                ...
                                <td class="border-b-[1px] border-[#0000001A] py-[12px] px-[15px]">
                                    @if((in_array('professions.add',$permissionDetails['accessableRoutes']) || in_array('professions.status',$permissionDetails['accessableRoutes']) ) || auth()->user()->role==1)
                ...
                <form method="POST" action={{ route('professions.add')}} class="space-y-[20px]">
                    ...
                    <div class="flex flex-col md:flex-row gap-[20px]">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="name" id="professionalName" value="" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none">
                        </div>
                    </div>
