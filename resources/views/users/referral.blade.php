                        ...
                        @foreach ($categoryData as $newCategorylist)
                            ...
                            <tr>
                                ...
                                <td class="border-b-[1px] border-[#0000001A] py-[12px] px-[15px]">
                                    @if((in_array('incorporations.add',$permissionDetails['accessableRoutes']) || in_array('referral.status',$permissionDetails['accessableRoutes'])) || auth()->user()->role==1)
                                        ...
                                        <div class="dropdown_menus absolute right-0 z-10 mt-2 w-[100px] origin-top-right rounded-md bg-white shadow-md ring-1 ring-black/5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                            <div class="text-start" role="none">
                                                ...
                                                @if(in_array('referral.status',$permissionDetails['accessableRoutes']) || auth()->user()->role==1)
                                                    <a href="{{ route('referral.status',['id'=>$newCategorylist->id,'val' => $newCategorylist->status])}}" class="client_status block border-b-[1px] border-[#0000001A] hover:bg-[#f7f7f7] px-3 py-1 text-[12px] text-gray-700">
                ...
                <form method="POST" action={{ route('referral.add')}} class="space-y-[20px]">
                    ...
                    <div class="flex flex-col md:flex-row gap-[20px]">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="name" id="referralName" value="" class="w-full h-[45px] border-[1px] border-[#0000001A] text-[14px] font-[400] leading-[16px] text-[#000000] tracking-[0.01em] px-[15px] py-[10px] rounded-[10px] !outline-none" required>
                        </div>
                    </div>
