...
<div>
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('users.addrole')}}" class=" inline-flex items-center gap-[10px] text-[13px] font-[500] leading-[15px] text-[#ffffff] tracking-[0.01em] bg-[#13103A] rounded-[10px] py-[12px] px-[30px] ">
